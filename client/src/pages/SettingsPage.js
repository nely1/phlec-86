                ...
                <div className="SettingsPageBox">
                    ...
                    {!change ? (
                        <>
                            ...
                            <p className="PersonalInfo">Username : &emsp; {userInfo.result.userName}</p>
                            <p className="PersonalInfo">Email : &emsp;&emsp;&emsp; {userInfo.result.email}</p>
                            <p className="PersonalInfo">Theme : &emsp;&emsp;&ensp; {userInfo.result.theme}</p>
